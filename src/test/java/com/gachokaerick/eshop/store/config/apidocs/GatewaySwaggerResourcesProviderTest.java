package com.gachokaerick.eshop.store.config.apidocs;

import static com.gachokaerick.eshop.store.config.apidocs.GatewaySwaggerResourcesProvider.swaggerResource;
