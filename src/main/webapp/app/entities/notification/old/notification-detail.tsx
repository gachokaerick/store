    ...
    <Row>
      <Col md="8">
        <h2 data-cy="notificationDetailsHeading">
          <Translate contentKey="storeApp.notification.detail.title">Notification</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="date">
              <Translate contentKey="storeApp.notification.date">Date</Translate>
            </span>
          </dt>
          <dd>{notificationEntity.date ? <TextFormat value={notificationEntity.date} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="details">
              <Translate contentKey="storeApp.notification.details">Details</Translate>
            </span>
          </dt>
          <dd>{notificationEntity.details}</dd>
          <dt>
            <span id="sentDate">
              <Translate contentKey="storeApp.notification.sentDate">Sent Date</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="format">
              <Translate contentKey="storeApp.notification.format">Format</Translate>
            </span>
          </dt>
          <dd>{notificationEntity.format}</dd>
          <dt>
            <Translate contentKey="storeApp.notification.user">User</Translate>
          </dt>
