  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.notification.home.createOrEditLabel" data-cy="NotificationCreateUpdateHeading">
            <Translate contentKey="storeApp.notification.home.createOrEditLabel">Create or edit a Notification</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.notification.date')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.notification.details')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.notification.sentDate')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.notification.format')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('storeApp.notification.user')}
                type="select"
                required
              >
                <option value="" key="0" />
