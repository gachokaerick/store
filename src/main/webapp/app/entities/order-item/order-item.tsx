            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('productName')}>
                  <Translate contentKey="storeApp.orderItem.productName">Product Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('pictureUrl')}>
                  <Translate contentKey="storeApp.orderItem.pictureUrl">Picture Url</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('unitPrice')}>
                  <Translate contentKey="storeApp.orderItem.unitPrice">Unit Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('discount')}>
                  <Translate contentKey="storeApp.orderItem.discount">Discount</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('units')}>
                  <Translate contentKey="storeApp.orderItem.units">Units</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('productId')}>
                  <Translate contentKey="storeApp.orderItem.productId">Product Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
