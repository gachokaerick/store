        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.orderItem.productName')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.orderItem.pictureUrl')}
                id="order-item-pictureUrl"
                name="pictureUrl"
                data-cy="pictureUrl"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('storeApp.orderItem.unitPrice')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.orderItem.discount')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.orderItem.units')}
                id="order-item-units"
                name="units"
                data-cy="units"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.orderItem.productId')}
