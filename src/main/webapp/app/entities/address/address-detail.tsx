    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="street">
              <Translate contentKey="storeApp.address.street">Street</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="town">
              <Translate contentKey="storeApp.address.town">Town</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="zipcode">
              <Translate contentKey="storeApp.address.zipcode">Zipcode</Translate>
            </span>
          </dt>
          <dd>{addressEntity.zipcode}</dd>
          <dt>
            <Translate contentKey="storeApp.address.buyer">Buyer</Translate>
          </dt>
