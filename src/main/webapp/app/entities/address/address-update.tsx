        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('storeApp.address.street')} id="address-street" name="street" data-cy="street" type="text" />
              <ValidatedField
                label={translate('storeApp.address.city')}
                id="address-city"
                name="city"
                data-cy="city"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.address.town')}
                id="address-town"
                name="town"
                data-cy="town"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.address.zipcode')}
                id="address-zipcode"
                name="zipcode"
                data-cy="zipcode"
                type="text"
              ...
              <ValidatedField
                ...
                name="buyer"
                data-cy="buyer"
                label={translate('storeApp.address.buyer')}
                type="select"
                required
              >
                <option value="" key="0" />
