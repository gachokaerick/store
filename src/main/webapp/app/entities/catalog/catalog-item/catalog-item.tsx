  ...
  return (
    <div>
      <h2 id="catalog-item-heading" data-cy="CatalogItemHeading">
        <Translate contentKey="storeApp.catalogCatalogItem.home.title">Catalog Items</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="storeApp.catalogCatalogItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.catalogCatalogItem.home.createLabel">Create new Catalog Item</Translate>
          </Link>
        </div>
      </h2>
        ...
        {catalogItemList && catalogItemList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="storeApp.catalogCatalogItem.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="storeApp.catalogCatalogItem.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="storeApp.catalogCatalogItem.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('price')}>
                  <Translate contentKey="storeApp.catalogCatalogItem.price">Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('pictureFileName')}>
                  <Translate contentKey="storeApp.catalogCatalogItem.pictureFileName">Picture File Name</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('pictureUrl')}>
                  <Translate contentKey="storeApp.catalogCatalogItem.pictureUrl">Picture Url</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('availableStock')}>
                  <Translate contentKey="storeApp.catalogCatalogItem.availableStock">Available Stock</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('restockThreshold')}>
                  <Translate contentKey="storeApp.catalogCatalogItem.restockThreshold">Restock Threshold</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('maxStockThreshold')}>
                  <Translate contentKey="storeApp.catalogCatalogItem.maxStockThreshold">Max Stock Threshold</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('onReorder')}>
                  <Translate contentKey="storeApp.catalogCatalogItem.onReorder">On Reorder</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="storeApp.catalogCatalogItem.catalogBrand">Catalog Brand</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="storeApp.catalogCatalogItem.catalogType">Catalog Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.catalogCatalogItem.home.notFound">No Catalog Items found</Translate>
            </div>
          )
        )}
      </div>
