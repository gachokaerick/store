...
export const CatalogItemDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="storeApp.catalogCatalogItem.delete.question">
        <Translate contentKey="storeApp.catalogCatalogItem.delete.question" interpolate={{ id: catalogItemEntity.id }}>
