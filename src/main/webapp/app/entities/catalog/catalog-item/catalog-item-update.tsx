  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.catalogCatalogItem.home.createOrEditLabel" data-cy="CatalogItemCreateUpdateHeading">
            <Translate contentKey="storeApp.catalogCatalogItem.home.createOrEditLabel">Create or edit a CatalogItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.catalogCatalogItem.name')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogCatalogItem.description')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogCatalogItem.price')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogCatalogItem.pictureFileName')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogCatalogItem.pictureUrl')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogCatalogItem.availableStock')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogCatalogItem.restockThreshold')}
              ...
              <ValidatedField
                label={translate('storeApp.catalogCatalogItem.maxStockThreshold')}
              ...
              <ValidatedField
                label={translate('storeApp.catalogCatalogItem.onReorder')}
              ...
              <ValidatedField
                ...
                label={translate('storeApp.catalogCatalogItem.catalogBrand')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="catalogType"
                data-cy="catalogType"
                label={translate('storeApp.catalogCatalogItem.catalogType')}
                type="select"
                required
              >
                <option value="" key="0" />
