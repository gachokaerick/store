    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="orderDate">
              <Translate contentKey="storeApp.order.orderDate">Order Date</Translate>
            </span>
          </dt>
          <dd>{orderEntity.orderDate ? <TextFormat value={orderEntity.orderDate} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="orderStatus">
              <Translate contentKey="storeApp.order.orderStatus">Order Status</Translate>
            </span>
          </dt>
          <dd>{orderEntity.orderStatus}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="storeApp.order.description">Description</Translate>
            </span>
          </dt>
          <dd>{orderEntity.description}</dd>
          <dt>
            <Translate contentKey="storeApp.order.address">Address</Translate>
          </dt>
          <dd>{orderEntity.address ? orderEntity.address.town : ''}</dd>
          <dt>
            <Translate contentKey="storeApp.order.buyer">Buyer</Translate>
          </dt>
