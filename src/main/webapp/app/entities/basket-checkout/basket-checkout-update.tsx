  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.basketCheckout.home.createOrEditLabel" data-cy="BasketCheckoutCreateUpdateHeading">
            <Translate contentKey="storeApp.basketCheckout.home.createOrEditLabel">Create or edit a BasketCheckout</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.basketCheckout.street')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.city')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.town')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.country')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.zipcode')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.createTime')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.updateTime')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.paymentStatus')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.payerCountryCode')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.payerEmail')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.payerName')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.payerSurname')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.payerId')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.currency')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.amount')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.paymentId')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.userLogin')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.basketCheckout.description')}
