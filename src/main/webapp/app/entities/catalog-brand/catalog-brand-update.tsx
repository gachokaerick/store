  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.catalogBrand.home.createOrEditLabel" data-cy="CatalogBrandCreateUpdateHeading">
            <Translate contentKey="storeApp.catalogBrand.home.createOrEditLabel">Create or edit a CatalogBrand</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.catalogBrand.brand')}
