  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.ordersPayment.home.createOrEditLabel" data-cy="PaymentCreateUpdateHeading">
            <Translate contentKey="storeApp.ordersPayment.home.createOrEditLabel">Create or edit a Payment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.ordersPayment.createTime')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersPayment.updateTime')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersPayment.paymentStatus')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersPayment.payerCountryCode')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersPayment.payerEmail')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersPayment.payerName')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersPayment.payerSurname')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersPayment.payerId')}
                id="payment-payerId"
                name="payerId"
                data-cy="payerId"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersPayment.currency')}
                id="payment-currency"
                name="currency"
                data-cy="currency"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersPayment.amount')}
                id="payment-amount"
                name="amount"
                data-cy="amount"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersPayment.paymentId')}
              ...
              <ValidatedField
                ...
                name="order"
                data-cy="order"
                label={translate('storeApp.ordersPayment.order')}
                type="select"
                required
              >
                <option value="" key="0" />
