...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './basket-item.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IBasketItem, defaultValue } from 'app/shared/model/orders/basket-item.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BASKETITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_BASKETITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BASKETITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BASKETITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BASKETITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BASKETITEM actions', async () => {
      const expectedActions = [
        {
