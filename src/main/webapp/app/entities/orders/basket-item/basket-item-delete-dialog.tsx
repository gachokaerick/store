...
export const BasketItemDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="storeApp.ordersBasketItem.delete.question">
        <Translate contentKey="storeApp.ordersBasketItem.delete.question" interpolate={{ id: basketItemEntity.id }}>
