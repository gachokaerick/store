  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.ordersBuyer.home.createOrEditLabel" data-cy="BuyerCreateUpdateHeading">
            <Translate contentKey="storeApp.ordersBuyer.home.createOrEditLabel">Create or edit a Buyer</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.ordersBuyer.firstName')}
                id="buyer-firstName"
                name="firstName"
                data-cy="firstName"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersBuyer.lastName')}
                id="buyer-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersBuyer.gender')}
                id="buyer-gender"
                name="gender"
                data-cy="gender"
                type="select"
              ...
              <ValidatedField
                label={translate('storeApp.ordersBuyer.email')}
                id="buyer-email"
                name="email"
                data-cy="email"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersBuyer.phone')}
                id="buyer-phone"
                name="phone"
                data-cy="phone"
                type="text"
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('storeApp.ordersBuyer.user')}
                type="select"
                required
              >
                <option value="" key="0" />
