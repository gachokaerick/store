    ...
    <Row>
      <Col md="8">
        <h2 data-cy="buyerDetailsHeading">
          <Translate contentKey="storeApp.ordersBuyer.detail.title">Buyer</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="firstName">
              <Translate contentKey="storeApp.ordersBuyer.firstName">First Name</Translate>
            </span>
          </dt>
          <dd>{buyerEntity.firstName}</dd>
          <dt>
            <span id="lastName">
              <Translate contentKey="storeApp.ordersBuyer.lastName">Last Name</Translate>
            </span>
          </dt>
          <dd>{buyerEntity.lastName}</dd>
          <dt>
            <span id="gender">
              <Translate contentKey="storeApp.ordersBuyer.gender">Gender</Translate>
            </span>
          </dt>
          <dd>{buyerEntity.gender}</dd>
          <dt>
            <span id="email">
              <Translate contentKey="storeApp.ordersBuyer.email">Email</Translate>
            </span>
          </dt>
          <dd>{buyerEntity.email}</dd>
          <dt>
            <span id="phone">
              <Translate contentKey="storeApp.ordersBuyer.phone">Phone</Translate>
            </span>
          </dt>
          <dd>{buyerEntity.phone}</dd>
          <dt>
            <Translate contentKey="storeApp.ordersBuyer.user">User</Translate>
          </dt>
