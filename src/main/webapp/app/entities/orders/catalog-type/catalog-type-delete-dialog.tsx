...
export const CatalogTypeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="storeApp.ordersCatalogType.delete.question">
        <Translate contentKey="storeApp.ordersCatalogType.delete.question" interpolate={{ id: catalogTypeEntity.id }}>
