...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './catalog-type.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICatalogType, defaultValue } from 'app/shared/model/orders/catalog-type.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATALOGTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATALOGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATALOGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATALOGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATALOGTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATALOGTYPE actions', async () => {
      const expectedActions = [
        {
