  ...
  return (
    <div>
      <h2 id="basket-checkout-heading" data-cy="BasketCheckoutHeading">
        <Translate contentKey="storeApp.ordersBasketCheckout.home.title">Basket Checkouts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="storeApp.ordersBasketCheckout.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.ordersBasketCheckout.home.createLabel">Create new Basket Checkout</Translate>
          </Link>
        </div>
      </h2>
        ...
        {basketCheckoutList && basketCheckoutList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('street')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.street">Street</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('city')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.city">City</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('town')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.town">Town</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('country')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('zipcode')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.zipcode">Zipcode</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('createTime')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.createTime">Create Time</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('updateTime')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.updateTime">Update Time</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('payerEmail')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.payerEmail">Payer Email</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('payerName')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.payerName">Payer Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('payerId')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.payerId">Payer Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('currency')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.currency">Currency</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('amount')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.amount">Amount</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('paymentId')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.paymentId">Payment Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('userLogin')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.userLogin">User Login</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="storeApp.ordersBasketCheckout.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.ordersBasketCheckout.home.notFound">No Basket Checkouts found</Translate>
            </div>
          )
        )}
      </div>
