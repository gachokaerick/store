  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.ordersNotification.home.createOrEditLabel" data-cy="NotificationCreateUpdateHeading">
            <Translate contentKey="storeApp.ordersNotification.home.createOrEditLabel">Create or edit a Notification</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.ordersNotification.date')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersNotification.details')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersNotification.sentDate')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersNotification.format')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('storeApp.ordersNotification.user')}
                type="select"
                required
              >
                <option value="" key="0" />
