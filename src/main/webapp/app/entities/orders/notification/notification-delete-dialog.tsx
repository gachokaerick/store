...
export const NotificationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="storeApp.ordersNotification.delete.question">
        <Translate contentKey="storeApp.ordersNotification.delete.question" interpolate={{ id: notificationEntity.id }}>
