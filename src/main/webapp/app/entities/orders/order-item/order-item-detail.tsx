    ...
    <Row>
      <Col md="8">
        <h2 data-cy="orderItemDetailsHeading">
          <Translate contentKey="storeApp.ordersOrderItem.detail.title">OrderItem</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="productName">
              <Translate contentKey="storeApp.ordersOrderItem.productName">Product Name</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.productName}</dd>
          <dt>
            <span id="pictureUrl">
              <Translate contentKey="storeApp.ordersOrderItem.pictureUrl">Picture Url</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.pictureUrl}</dd>
          <dt>
            <span id="unitPrice">
              <Translate contentKey="storeApp.ordersOrderItem.unitPrice">Unit Price</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.unitPrice}</dd>
          <dt>
            <span id="discount">
              <Translate contentKey="storeApp.ordersOrderItem.discount">Discount</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.discount}</dd>
          <dt>
            <span id="units">
              <Translate contentKey="storeApp.ordersOrderItem.units">Units</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.units}</dd>
          <dt>
            <span id="productId">
              <Translate contentKey="storeApp.ordersOrderItem.productId">Product Id</Translate>
            </span>
          </dt>
          <dd>{orderItemEntity.productId}</dd>
          <dt>
            <Translate contentKey="storeApp.ordersOrderItem.order">Order</Translate>
          </dt>
