  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.ordersOrderItem.home.createOrEditLabel" data-cy="OrderItemCreateUpdateHeading">
            <Translate contentKey="storeApp.ordersOrderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.ordersOrderItem.productName')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersOrderItem.pictureUrl')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersOrderItem.unitPrice')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersOrderItem.discount')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersOrderItem.units')}
                id="order-item-units"
                name="units"
                data-cy="units"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersOrderItem.productId')}
              ...
              <ValidatedField
                ...
                name="order"
                data-cy="order"
                label={translate('storeApp.ordersOrderItem.order')}
                type="select"
                required
              >
                <option value="" key="0" />
