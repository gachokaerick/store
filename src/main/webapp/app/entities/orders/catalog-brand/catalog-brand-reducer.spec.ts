...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './catalog-brand.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICatalogBrand, defaultValue } from 'app/shared/model/orders/catalog-brand.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATALOGBRAND_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATALOGBRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATALOGBRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATALOGBRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATALOGBRAND actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATALOGBRAND actions', async () => {
      const expectedActions = [
        {
