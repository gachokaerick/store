  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.ordersCatalogBrand.home.createOrEditLabel" data-cy="CatalogBrandCreateUpdateHeading">
            <Translate contentKey="storeApp.ordersCatalogBrand.home.createOrEditLabel">Create or edit a CatalogBrand</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.ordersCatalogBrand.brand')}
