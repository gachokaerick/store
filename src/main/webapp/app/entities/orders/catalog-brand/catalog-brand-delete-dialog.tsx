...
export const CatalogBrandDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="storeApp.ordersCatalogBrand.delete.question">
        <Translate contentKey="storeApp.ordersCatalogBrand.delete.question" interpolate={{ id: catalogBrandEntity.id }}>
