...
import { getEntities as getAddresses } from 'app/entities/orders/address/address.reducer';
import { IBuyer } from 'app/shared/model/orders/buyer.model';
import { getEntities as getBuyers } from 'app/entities/orders/buyer/buyer.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.ordersOrder.home.createOrEditLabel" data-cy="OrderCreateUpdateHeading">
            <Translate contentKey="storeApp.ordersOrder.home.createOrEditLabel">Create or edit a Order</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.ordersOrder.orderDate')}
                id="order-orderDate"
                name="orderDate"
                data-cy="orderDate"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('storeApp.ordersOrder.orderStatus')}
              ...
              <ValidatedField
                label={translate('storeApp.ordersOrder.description')}
              ...
              <ValidatedField
                ...
                name="address"
                data-cy="address"
                label={translate('storeApp.ordersOrder.address')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="buyer"
                data-cy="buyer"
                label={translate('storeApp.ordersOrder.buyer')}
                type="select"
                required
              >
                <option value="" key="0" />
