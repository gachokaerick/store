...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUTHORIZATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUTHORIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUTHORIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUTHORIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUTHORIZATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUTHORIZATION actions', async () => {
      const expectedActions = [
        {
