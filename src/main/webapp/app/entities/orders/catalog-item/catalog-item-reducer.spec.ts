...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './catalog-item.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { ICatalogItem, defaultValue } from 'app/shared/model/orders/catalog-item.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATALOGITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATALOGITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATALOGITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATALOGITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATALOGITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATALOGITEM actions', async () => {
      const expectedActions = [
        {
