  ...
  return (
    <div>
      <h2 id="catalog-item-heading" data-cy="CatalogItemHeading">
        <Translate contentKey="storeApp.ordersCatalogItem.home.title">Catalog Items</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="storeApp.ordersCatalogItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.ordersCatalogItem.home.createLabel">Create new Catalog Item</Translate>
          </Link>
        </div>
      </h2>
        ...
        {catalogItemList && catalogItemList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="storeApp.ordersCatalogItem.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="storeApp.ordersCatalogItem.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="storeApp.ordersCatalogItem.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('price')}>
                  <Translate contentKey="storeApp.ordersCatalogItem.price">Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('pictureUrl')}>
                  <Translate contentKey="storeApp.ordersCatalogItem.pictureUrl">Picture Url</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('onReorder')}>
                  <Translate contentKey="storeApp.ordersCatalogItem.onReorder">On Reorder</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="storeApp.ordersCatalogItem.catalogBrand">Catalog Brand</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="storeApp.ordersCatalogItem.catalogType">Catalog Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.ordersCatalogItem.home.notFound">No Catalog Items found</Translate>
            </div>
          )
        )}
      </div>
