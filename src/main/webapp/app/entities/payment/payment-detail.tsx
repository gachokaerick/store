    ...
    <Row>
      <Col md="8">
        <h2 data-cy="paymentDetailsHeading">
          <Translate contentKey="storeApp.payment.detail.title">Payment</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="createTime">
              <Translate contentKey="storeApp.payment.createTime">Create Time</Translate>
            </span>
          </dt>
          <dd>{paymentEntity.createTime ? <TextFormat value={paymentEntity.createTime} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="updateTime">
              <Translate contentKey="storeApp.payment.updateTime">Update Time</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="paymentStatus">
              <Translate contentKey="storeApp.payment.paymentStatus">Payment Status</Translate>
            </span>
          </dt>
          <dd>{paymentEntity.paymentStatus}</dd>
          <dt>
            <span id="payerCountryCode">
              <Translate contentKey="storeApp.payment.payerCountryCode">Payer Country Code</Translate>
            </span>
          </dt>
          <dd>{paymentEntity.payerCountryCode}</dd>
          <dt>
            <span id="payerEmail">
              <Translate contentKey="storeApp.payment.payerEmail">Payer Email</Translate>
            </span>
          </dt>
          <dd>{paymentEntity.payerEmail}</dd>
          <dt>
            <span id="payerName">
              <Translate contentKey="storeApp.payment.payerName">Payer Name</Translate>
            </span>
          </dt>
          <dd>{paymentEntity.payerName}</dd>
          <dt>
            <span id="payerSurname">
              <Translate contentKey="storeApp.payment.payerSurname">Payer Surname</Translate>
            </span>
          </dt>
          <dd>{paymentEntity.payerSurname}</dd>
          <dt>
            <span id="payerId">
              <Translate contentKey="storeApp.payment.payerId">Payer Id</Translate>
            </span>
          </dt>
          <dd>{paymentEntity.payerId}</dd>
          <dt>
            <span id="currency">
              <Translate contentKey="storeApp.payment.currency">Currency</Translate>
            </span>
          </dt>
          <dd>{paymentEntity.currency}</dd>
          <dt>
            <span id="amount">
              <Translate contentKey="storeApp.payment.amount">Amount</Translate>
            </span>
          </dt>
          <dd>{paymentEntity.amount}</dd>
          <dt>
            <span id="paymentId">
              <Translate contentKey="storeApp.payment.paymentId">Payment Id</Translate>
            </span>
          </dt>
          <dd>{paymentEntity.paymentId}</dd>
          <dt>
            <Translate contentKey="storeApp.payment.order">Order</Translate>
          </dt>
