...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BASKETCHECKOUT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BASKETCHECKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BASKETCHECKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BASKETCHECKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BASKETCHECKOUT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BASKETCHECKOUT actions', async () => {
      const expectedActions = [
        {
