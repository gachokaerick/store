...
export const BasketItemDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="storeApp.basketBasketItem.delete.question">
        <Translate contentKey="storeApp.basketBasketItem.delete.question" interpolate={{ id: basketItemEntity.id }}>
