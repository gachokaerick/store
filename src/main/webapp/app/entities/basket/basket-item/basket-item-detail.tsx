    ...
    <Row>
      <Col md="8">
        <h2 data-cy="basketItemDetailsHeading">
          <Translate contentKey="storeApp.basketBasketItem.detail.title">BasketItem</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="productId">
              <Translate contentKey="storeApp.basketBasketItem.productId">Product Id</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.productId}</dd>
          <dt>
            <span id="productName">
              <Translate contentKey="storeApp.basketBasketItem.productName">Product Name</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.productName}</dd>
          <dt>
            <span id="unitPrice">
              <Translate contentKey="storeApp.basketBasketItem.unitPrice">Unit Price</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.unitPrice}</dd>
          <dt>
            <span id="oldUnitPrice">
              <Translate contentKey="storeApp.basketBasketItem.oldUnitPrice">Old Unit Price</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.oldUnitPrice}</dd>
          <dt>
            <span id="quantity">
              <Translate contentKey="storeApp.basketBasketItem.quantity">Quantity</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.quantity}</dd>
          <dt>
            <span id="pictureUrl">
              <Translate contentKey="storeApp.basketBasketItem.pictureUrl">Picture Url</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.pictureUrl}</dd>
          <dt>
            <span id="userLogin">
              <Translate contentKey="storeApp.basketBasketItem.userLogin">User Login</Translate>
            </span>
          </dt>
