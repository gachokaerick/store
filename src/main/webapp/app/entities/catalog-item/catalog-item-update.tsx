...
import { getEntities as getCatalogBrands } from 'app/entities/catalog-brand/catalog-brand.reducer';
import { ICatalogType } from 'app/shared/model/catalog-type.model';
import { getEntities as getCatalogTypes } from 'app/entities/catalog-type/catalog-type.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.catalogItem.home.createOrEditLabel" data-cy="CatalogItemCreateUpdateHeading">
            <Translate contentKey="storeApp.catalogItem.home.createOrEditLabel">Create or edit a CatalogItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.catalogItem.name')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogItem.description')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogItem.price')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogItem.pictureFileName')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogItem.pictureUrl')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogItem.availableStock')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.catalogItem.restockThreshold')}
              ...
              <ValidatedField
                label={translate('storeApp.catalogItem.maxStockThreshold')}
              ...
              <ValidatedField
                label={translate('storeApp.catalogItem.onReorder')}
              ...
              <ValidatedField
                ...
                label={translate('storeApp.catalogItem.catalogBrand')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="catalogType"
                data-cy="catalogType"
                label={translate('storeApp.catalogItem.catalogType')}
                type="select"
                required
              >
                <option value="" key="0" />
