...
import { IBasketItem } from 'app/shared/model/basket-item.model';
  ...
  return (
    <div>
      <h2 id="basket-item-heading" data-cy="BasketItemHeading">
        <Translate contentKey="storeApp.basketItem.home.title">Basket Items</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="storeApp.basketItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="storeApp.basketItem.home.createLabel">Create new Basket Item</Translate>
          </Link>
        </div>
      </h2>
        ...
        {basketItemList && basketItemList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="storeApp.basketItem.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('productId')}>
                  <Translate contentKey="storeApp.basketItem.productId">Product Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('productName')}>
                  <Translate contentKey="storeApp.basketItem.productName">Product Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('unitPrice')}>
                  <Translate contentKey="storeApp.basketItem.unitPrice">Unit Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('oldUnitPrice')}>
                  <Translate contentKey="storeApp.basketItem.oldUnitPrice">Old Unit Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('quantity')}>
                  <Translate contentKey="storeApp.basketItem.quantity">Quantity</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('pictureUrl')}>
                  <Translate contentKey="storeApp.basketItem.pictureUrl">Picture Url</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('userLogin')}>
                  <Translate contentKey="storeApp.basketItem.userLogin">User Login</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.basketItem.home.notFound">No Basket Items found</Translate>
            </div>
          )
        )}
      </div>
