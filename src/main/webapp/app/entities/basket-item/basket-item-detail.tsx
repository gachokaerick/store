    ...
    <Row>
      <Col md="8">
        <h2 data-cy="basketItemDetailsHeading">
          <Translate contentKey="storeApp.basketItem.detail.title">BasketItem</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="productId">
              <Translate contentKey="storeApp.basketItem.productId">Product Id</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.productId}</dd>
          <dt>
            <span id="productName">
              <Translate contentKey="storeApp.basketItem.productName">Product Name</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.productName}</dd>
          <dt>
            <span id="unitPrice">
              <Translate contentKey="storeApp.basketItem.unitPrice">Unit Price</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.unitPrice}</dd>
          <dt>
            <span id="oldUnitPrice">
              <Translate contentKey="storeApp.basketItem.oldUnitPrice">Old Unit Price</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.oldUnitPrice}</dd>
          <dt>
            <span id="quantity">
              <Translate contentKey="storeApp.basketItem.quantity">Quantity</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.quantity}</dd>
          <dt>
            <span id="pictureUrl">
              <Translate contentKey="storeApp.basketItem.pictureUrl">Picture Url</Translate>
            </span>
          </dt>
          <dd>{basketItemEntity.pictureUrl}</dd>
          <dt>
            <span id="userLogin">
              <Translate contentKey="storeApp.basketItem.userLogin">User Login</Translate>
            </span>
          </dt>
